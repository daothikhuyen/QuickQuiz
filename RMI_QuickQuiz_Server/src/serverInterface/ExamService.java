...
public interface ExamService extends Remote {
	...
	Server_Response get_exmas_userId(int userId) throws RemoteException;
	...
	Server_Response unregisterCallback(String clientID) throws RemoteException; // Hủy đăng ký
